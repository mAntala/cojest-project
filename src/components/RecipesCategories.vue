<template>
    <section class="categories-list">
        <div
            ...
            @click="categoryActivate(category.text, index)"
            class="category">
...
export default {
    ...
    methods: {
        categoryActivate(category, index) {
            this.$emit('activate-category', {category, index});
        }
    }
}
</script>
